...
abstract class BaseAbstractGateway extends AbstractGateway
{
    ...
    public function transfer($parameters = array ()){
        return $this->createRequest('\Omnipay\WechatPay\Message\TransferOrderRequest',$parameters);
    }

    //查询openid
    public function queryOpenId($parameters = array()){
        return $this->createRequest('\Omnipay\WechatPay\Message\QueryOpenIdRequest',$parameters);
    }
}
