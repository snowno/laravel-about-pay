...
class TransferOrderRequest extends BaseAbstractRequest
{
    ...
    public function setOpenId($openid){
        ...
        return $this->values['openid']= $openid;
    }
    ...
    public function setAmount($value){
        return $this->values['amount'] = $value;
    }
    ...
    public function setCheckName($value){
        ...
        return $this->values['check_name'] = strtoupper($value);
    }
    ...
    public function getMchAppid(){
        ...
        return $this->values['mch_appid'] = config('wechat.appid');
    }
    ...
    public function getMCHID(){
        ...
        return $this->values['mchid'] = config('wechat.mchid');
    }
    ...
    public function getNonceStr(){
        ...
        return $this->values['nonce_str'] = 'qyzf'.rand(100000, 999999);
    }
    ...
    public function getPartnerTradeNo(){
        ...
        return $this->values['partner_trade_no'] = 'xx'.time().rand(10000, 99999);
    }
    ...
    public function setReUserName($value){
        return $this->values['re_user_name'] = $value;
    }
